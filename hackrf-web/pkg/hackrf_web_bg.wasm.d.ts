...
export const dsp_configure: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
export const dsp_free: (a: number) => void;
export const dsp_get_iq_output_len: (a: number) => number;
export const dsp_new: (a: number, b: number, c: number) => number;
export const dsp_process_iq_only_ptr: (a: number, b: number, c: number) => number;
export const dsp_process_ptr: (a: number, b: number, c: number) => number;
export const dsp_reset: (a: number) => void;
export const dsp_set_if_sample_rate: (a: number, b: number) => void;
...
export const dsp_get_output_len: (a: number) => number;
